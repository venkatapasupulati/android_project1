...
public class HardActivity extends AppCompatActivity {
    private DrawOfDecks drawOfDecks = new DrawOfDecks();
    private int count =1;
   ...
   private int firstgridSelected = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int column = getIntent().getIntExtra("column",6);
...
//                    imageView.setClickable(false);
                    ...
                    //Toast.makeText(HardActivity.this, "i="+ finalI+" count="+ count, Toast.LENGTH_SHORT).show();
                    ...
                    //selectedImage.setImageResource(selectId);
                    count++;
